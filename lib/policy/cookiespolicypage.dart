...
import 'package:wiseintern/policy/cookiespolicy.dart';

class CookiesPolicyPage extends StatefulWidget {
  @override
  _CookiesPolicyPageState createState() => _CookiesPolicyPageState();
}

class _CookiesPolicyPageState extends State<CookiesPolicyPage> {
  int _currentIndex = 0;
